...
-- 1. Create project-attachments storage bucket
...
-- 2. Create RLS policies for project-attachments bucket
...
-- 6. Ensure projects table has proper RLS policies for clients
