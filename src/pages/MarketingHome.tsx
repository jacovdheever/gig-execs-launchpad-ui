      ...
      <section id="home" className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
          <div className="relative z-10">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#012E46] mb-6 leading-tight text-shadow-xl animate-fade-in-up">
              GigExecs: The Premier Freelance Hub for{' '}
              <span className="bg-gradient-to-r from-[#0284C7] to-[#FACC15] bg-clip-text text-transparent text-shadow-xl">
                Top Professionals
              </span>
            </h1>
            <p className="text-lg sm:text-xl text-[#012E46]/90 mb-8 max-w-3xl mx-auto leading-relaxed text-shadow-lg animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <Button size="lg" className="bg-[#012E46] hover:bg-[#0284C7] text-white px-8 py-3 text-shadow-lg transition-all duration-300 hover:scale-105">
              ...
              <Button variant="outline" size="lg" className="border-[#012E46] text-[#012E46] hover:bg-[#012E46] hover:text-white px-8 py-3 text-shadow-lg backdrop-blur-sm bg-white/10 transition-all duration-300 hover:scale-105">
                Learn More
              </Button>
            </div>
          </div>
