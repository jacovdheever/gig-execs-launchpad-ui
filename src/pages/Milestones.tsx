            ...
            <div style={{
              ...
              {expandedItems.includes(0) && (
                <p style={{
                  ...
                  Milestones are significant points or events in a project that mark progress toward a specific goal or achievement. They serve as checkpoints to track the completion of key tasks or phases within the project timeline.
                </p>
              )}
            </div>
            <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                How do I create milestones for my project?
              </h3>
              {expandedItems.includes(1) && (
                <p style={{
                  ...
                  To create milestones for your project, identify key objectives or deliverables and break them down into smaller, measurable tasks. Assign specific dates or deadlines to each milestone to track progress effectively.
                </p>
              )}
            </div>
            <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                What should I do if a milestone is not met as planned?
              </h3>
              {expandedItems.includes(2) && (
                <p style={{
                  ...
                  If a milestone is not met as planned, assess the reasons for the delay and take corrective action as necessary. This may involve reallocating resources, adjusting timelines, or revising project plans to ensure future milestones are achieved on time.
                </p>
              )}
            </div>
            <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                How do milestones impact project payments?
              </h3>
              {expandedItems.includes(3) && (
                <p style={{
                  ...
                  Milestones serve as payment triggers in project contracts or agreements. Payments may be tied to the completion of specific milestones, ensuring that work is delivered satisfactorily before payment is made.
                </p>
              )}
            </div>
            <div style={{
