            ...
            <div style={{
              ...
              {expandedItems.includes(0) && (
                <p style={{
                  ...
                  We only accept payment methods through credit/debit cards at this time. We strive to provide a seamless and secure payment experience for our users, and credit/debit card transactions offer a convenient and widely accepted method for processing payments on our platform. We apologise for any inconvenience this may cause and appreciate your understanding. If you have any questions or concerns regarding payment methods, please don't hesitate to contact our support team for assistance.
                </p>
              )}
            </div>
            <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                How can I add or update my payment method?
              </h3>
              {expandedItems.includes(1) && (
                <p style={{
                  ...
                  You can add or update your payment method in your account settings. Simply navigate to the "Payment Methods" section under your profile and follow the prompts to add a new payment method or update existing ones.
                </p>
              )}
            </div>
            <div style={{
            ...
            <div style={{
              ...
              {expandedItems.includes(2) && (
                <p style={{
                  ...
                  We strive to provide transparent pricing, and there are typically no additional fees for using standard payment methods. However, please check with your financial institution for any potential transaction fees they may charge.
                </p>
              )}
            </div>
            <div style={{
