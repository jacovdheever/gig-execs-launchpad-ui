        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{
              ...
              What payment methods are accepted on GigExecs?
            </h3>
            {expandedItems.includes(0) && (
              <p style={{
                ...
                We accept major credit cards (Visa, MasterCard, American Express), debit cards, and bank transfers. All payments are processed securely through our platform with encryption and fraud protection measures in place.
              </p>
            )}
          </div>
          <div style={{
          ...
          <div style={{
            ...
            {expandedItems.includes(1) && (
              <p style={{
                ...
                All payment transactions are secured with bank-level encryption and PCI DSS compliance. We use industry-standard security protocols to protect your financial information and never store sensitive payment data on our servers.
              </p>
            )}
          </div>
          <div style={{
          ...
          <div style={{
            ...
            {expandedItems.includes(2) && (
              <p style={{
                ...
                Yes, you can set up automatic payments for recurring projects or retainers. This ensures timely payments and reduces administrative overhead. You can manage your automatic payment settings in your account dashboard.
              </p>
            )}
          </div>
          <div style={{
          ...
          <div style={{
            ...
            {expandedItems.includes(3) && (
              <p style={{
                ...
                If a payment fails, you'll receive a notification and can update your payment method. Failed payments don't affect your account status, but you'll need to resolve the issue before making new payments. Contact support if you need assistance.
              </p>
            )}
          </div>
          <div style={{
