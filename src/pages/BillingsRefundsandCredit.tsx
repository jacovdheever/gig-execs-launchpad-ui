          ...
          <div style={{
            ...
            {expandedItems.includes(0) && (
              <p style={{
                ...
                You may be eligible for a refund if work is not delivered as agreed, quality standards are not met, or the consultant fails to complete the project. Refunds are processed after review and approval through our dispute resolution process.
              </p>
            )}
          </div>
          <div style={{
          ...
          <div style={{
            ...
            {expandedItems.includes(1) && (
              <p style={{
                ...
                Submit a refund request through the platform's dispute resolution system. Provide detailed documentation of the issue, evidence of non-delivery or poor quality, and any communication with the consultant. Our team will review your case.
              </p>
            )}
          </div>
          <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{
              ...
              What is platform credit and how does it work?
            </h3>
            {expandedItems.includes(2) && (
              <p style={{
                ...
                Platform credit is account balance that can be used for future projects. Credits are issued for refunds, bonuses, or promotional offers. They can be applied to any project on the platform and never expire. Credits are non-transferable.
              </p>
            )}
          </div>
          <div style={{
