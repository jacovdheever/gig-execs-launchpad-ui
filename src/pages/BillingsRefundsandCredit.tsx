...
const BillingsRefundsandCredit = () => {
  const [expandedItems, setExpandedItems] = useState<number[]>([0, 1, 2]) // All items start expanded
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                What is the refund policy for services rendered?
              </h3>
              {expandedItems.includes(0) && (
                <p style={{
                  ...
                  Our refund policy varies depending on the circumstances. Generally, refunds are issued in accordance with the terms of the agreement between clients and freelancers/consultants. Please refer to the project contract or contact our billing support team for more information.
                </p>
              )}
            </div>
            <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                How long does it take to process refunds or issue credits?
              </h3>
              {expandedItems.includes(1) && (
                <p style={{
                  ...
                  Refunds and credits are typically processed within a specified timeframe, which may vary depending on the payment method and financial institution. We strive to process refunds promptly once the request is approved.
                </p>
              )}
            </div>
            <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                What should I do if I believe I'm eligible for a refund or credit?
              </h3>
              {expandedItems.includes(2) && (
                <p style={{
                  ...
                  If you believe you're eligible for a refund or credit, please contact our billing support team with details of your request. We'll review your case and provide assistance in processing the refund or issuing credits accordingly.
                </p>
              )}
            </div>
            <div style={{
...
export default BillingsRefundsandCredit 