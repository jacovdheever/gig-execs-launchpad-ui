            ...
            <div style={{
              ...
              {expandedItems.includes(1) && (
                <p style={{
                  ...
                  You can upgrade or downgrade your subscription plan at any time by accessing your account settings. Simply select the desired plan and follow the prompts to make the change.
                </p>
              )}
            </div>
            <div style={{
            ...
            <div style={{
              ...
              {expandedItems.includes(2) && (
                <p style={{
                  ...
                  Yes, you can cancel your subscription at any time. However, please note that cancellation may affect access to certain features or services associated with your subscription plan.
                </p>
              )}
            </div>
            <div style={{
