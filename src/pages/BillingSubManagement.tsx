        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{
              ...
              How do I manage my subscription settings?
            </h3>
            {expandedItems.includes(0) && (
              <p style={{
                ...
                Access your subscription settings through your account dashboard. You can update payment methods, change subscription plans, modify billing frequency, and manage automatic renewals. All changes are applied immediately or at the next billing cycle.
              </p>
            )}
          </div>
          <div style={{
          ...
          <div style={{
            ...
            {expandedItems.includes(1) && (
              <p style={{
                ...
                Yes, you can cancel your subscription at any time through your account settings. Cancellation takes effect at the end of your current billing period. You'll retain access to services until the period ends, and no further charges will be applied.
              </p>
            )}
          </div>
          <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{
              ...
              What happens if my payment fails for a subscription?
            </h3>
            {expandedItems.includes(2) && (
              <p style={{
                ...
                If a subscription payment fails, you'll receive a notification and have a grace period to update your payment method. If the issue isn't resolved, your subscription may be suspended. Contact support immediately to avoid service interruption.
              </p>
            )}
          </div>
          <div style={{
...
export default BillingSubManagement 