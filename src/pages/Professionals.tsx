        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
          <div className="relative z-10">
            ...
            <p className="text-lg sm:text-xl text-[#9CA3AF] mb-8 max-w-3xl mx-auto leading-relaxed">
              Connect with top-tier projects and clients who value your expertise. Start your freelance journey with confidence.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#9CA3AF] max-w-2xl mx-auto">
              We make it easier to showcase your skills, find quality projects, and build your freelance career.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent>
                <CardDescription className="text-[#9CA3AF]">
                  Set your own rates and see exactly what you'll earn from each project.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent>
                <CardDescription className="text-[#9CA3AF]">
                  Get feedback and ratings from clients to build your credibility in the community.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent>
                <CardDescription className="text-[#9CA3AF]">
                  Engage directly with clients using our built-in chat and project management tools.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
