  ...
  return (
    <div className="min-h-screen bg-transparent">
              ...
              <div style={{ 
                ...
                <p style={{ color: "#012E46", fontSize: 16, lineHeight: "24px", marginBottom: 16 }}>
                  Explore how our platform is revolutionizing the way experienced professionals connect with meaningful opportunities. We provide flexible work solutions and address ageism challenges.
                                 ...
                                 <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                   <span style={{ color: "#999", fontSize: 14 }}>Nuno G. Rodrigues | June 8, 2024</span>
                 </div>
                {/* Separator line */}
                <div style={{ 
                  display: "flex",
        ...
        <div style={{ 
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 32, marginBottom: 32, width: "100%" }}>
            ...
            <div style={{ textAlign: "center", padding: 8 }}>
              ...
              <h3 style={{ fontSize: 16, fontWeight: 600, color: "white", marginBottom: 8 }}>Create a Job</h3>
              <p style={{ color: "white", fontSize: 16, fontFamily: "Montserrat, sans-serif", fontWeight: 400, lineHeight: "19.20px", wordWrap: "break-word" }}>Outline the scope, required skills, timeline, and budget to find the perfect expert.</p>
            </div>
            ...
            <div style={{ textAlign: "center", padding: 8 }}>
              ...
              <h3 style={{ fontSize: 16, fontWeight: 600, color: "white", marginBottom: 8 }}>Browse for Talent</h3>
              <p style={{ color: "white", fontSize: 16, fontFamily: "Montserrat, sans-serif", fontWeight: 400, lineHeight: "19.20px", wordWrap: "break-word" }}>Browse profiles and portfolios to find the best fit for your project.</p>
            </div>
            ...
            <div style={{ textAlign: "center", padding: 8 }}>
              ...
              <h3 style={{ fontSize: 16, fontWeight: 600, color: "white", marginBottom: 8 }}>Identify Potential Experts </h3>
              <p style={{ color: "white", fontSize: 16, fontFamily: "Montserrat, sans-serif", fontWeight: 400, lineHeight: "19.20px", wordWrap: "break-word" }}>Start searching for top consultants tailored to your needs.</p>
            </div>
            ...
            <div style={{ textAlign: "center", padding: 32 }}>
              ...
              <h3 style={{ fontSize: 16, fontWeight: 600, color: "white", marginBottom: 8 }}>Accept a Bid</h3>
            ...
            <div style={{ textAlign: "center", padding: 32 }}>
              ...
              <h3 style={{ fontSize: 16, fontWeight: 600, color: "white", marginBottom: 8 }}>Track the progress</h3>
              <p style={{ color: "white", fontSize: 16, fontFamily: "Montserrat, sans-serif", fontWeight: 400, lineHeight: "19.20px", wordWrap: "break-word" }}>Evaluate the deliverables and complete payment.</p>
            </div>
      ...
      <section style={{ padding: "80px 80px", background: "transparent" }}>
        <div style={{ maxWidth: 1440, margin: "0 auto" }}>
          <div style={{ marginBottom: 20 }}>
            <div style={{ color: "#ffffff", fontSize: 18, fontFamily: "Montserrat, sans-serif", fontWeight: 700, lineHeight: "21.60px", wordWrap: "break-word" }}>
              Why Choose GigExecs?
            </div>
          </div>
      ...
      >
        <div style={{ width: '100%', height: '100%', padding: 32, left: 0, top: 0, position: 'relative', background: 'linear-gradient(136deg, rgba(255, 255, 255, 0.21) 0%, rgba(0, 0, 0, 0.12) 50%, rgba(255, 255, 255, 0.21) 100%)', borderRadius: 24, outline: '1px rgba(255, 255, 255, 0.30) solid', outlineOffset: -1, backdropFilter: 'blur(5px)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-end', gap: 32, display: 'inline-flex', margin: '0 auto' }}>
          <div style={{ alignSelf: 'stretch', textAlign: 'center', color: 'white', fontSize: 40, fontFamily: 'Montserrat, sans-serif', fontWeight: 700, lineHeight: '48px', wordWrap: 'break-word' }}>Need help but don't have time to post, browse, or monitor your project? We can assist with that too.</div>
          <div data-content="Icons & Text" data-hierarchy="Secondary" data-left-icon="false" data-right-icon="false" data-size="Large" data-state="Default" data-style="Filled" style={{ width: 302, paddingLeft: 24, paddingRight: 24, paddingTop: 16, paddingBottom: 16, background: '#CC9B0A', justifyContent: 'center', alignItems: 'center', gap: 8, display: 'inline-flex' }}>
            <div style={{ textAlign: 'center', color: 'white', fontSize: 18, fontFamily: 'Montserrat, sans-serif', fontWeight: 700, lineHeight: '21.60px', wordWrap: 'break-word' }}>Book a Call</div>
          </div>
        </div>
        <div style={{ height: 64 }} />
      </section>
