...
def test_references_migration():
    """Test migration of references with a few records"""
    ...
    print("🧪 Testing references migration with a few records...")
    print("=" * 60)
