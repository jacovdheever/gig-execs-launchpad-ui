...
def migrate_education_with_existing_users():
    """Migrate education data using existing user IDs from database"""
    ...
    print("🚀 Starting education migration using existing user IDs...")
    print("=" * 60)
    ...
    # Save statistics
    stats_file = Path('data/education_migration_stats_existing_users.json')
    ...
    # Print summary
    print("📊 Education Migration Summary (Using Existing Users):")
...
if __name__ == "__main__":
    migrate_education_with_existing_users() 