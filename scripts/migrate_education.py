...
def migrate_education():
    """Migrate education data from CSV to Supabase"""
    ...
    print("🚀 Starting education migration...")
    print("=" * 60)
    ...
    with open(csv_file, 'r', encoding='utf-8') as file:
        ...
        for row in reader:
            ...
            for education_entry in education_entries:
                ...
                if not education_entry['institution_name'] or not education_entry['start_date']:
    ...
    # Save statistics
    stats_file = Path('data/education_migration_stats.json')
    ...
    # Print summary
    print("📊 Education Migration Summary:")
    ...
    print(f"   User not found errors: {stats['user_not_found_errors']}")
